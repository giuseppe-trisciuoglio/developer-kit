...
if [ -z "$1" ]; then
    ...
    echo "Usage: /devkit.github.review-pr <pr-number> [review-focus] [output-format]"
    exit 1
fi
...
/devkit.github.review-pr 456 security
```
...
/devkit.github.review-pr 789 full detailed
```
...
/devkit.github.review-pr 321 performance checklist
```
