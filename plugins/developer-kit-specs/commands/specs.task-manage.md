...
5. Populate the task file with:
   - Frontmatter (id, title, spec, status: pending)
   - Description
   - Acceptance Criteria (ask user or derive from spec)
   - Definition of Done (standard items)
