...
**Input**: Task file generated by `/developer-kit-specs:specs.spec-to-tasks`
...
6. **Prepare for Implementation**: Provide clear handoff to `/developer-kit-specs:specs.task-implementation` with test files ready
...
Task file updates are handled by `plugins/developer-kit-specs/hooks/specs-task-tdd-updater.py`, which preserves the task body, merges `testReferences` metadata into frontmatter, and writes a replaceable RED-phase summary block. Implementation handoff preparation is handled by `plugins/developer-kit-specs/hooks/specs-task-tdd-handoff.py`, which creates `_drift/tdd-handoff-*.md` in the spec folder with the generated test summary, RED status, preserved task context, and the exact `/developer-kit-specs:specs.task-implementation` command for GREEN phase.

## Usage

```bash
# Basic usage - generate tests for a specific task
/developer-kit-specs:specs.task-tdd --task="docs/specs/001-hotel-search/tasks/TASK-003.md"

# With language specification
/developer-kit-specs:specs.task-tdd --lang=spring --task="docs/specs/001-user-auth/tasks/TASK-005.md"
/developer-kit-specs:specs.task-tdd --lang=typescript --task="docs/specs/001-api-integration/tasks/TASK-012.md"
/developer-kit-specs:specs.task-tdd --lang=nestjs --task="docs/specs/001-user-auth/tasks/TASK-008.md"
/developer-kit-specs:specs.task-tdd --lang=react --task="docs/specs/001-ui-components/tasks/TASK-015.md"
/developer-kit-specs:specs.task-tdd --lang=python --task="docs/specs/001-data-processing/tasks/TASK-007.md"
/developer-kit-specs:specs.task-tdd --lang=php --task="docs/specs/001-wordpress-plugin/tasks/TASK-009.md"

# General language (template structure, language-agnostic)
/developer-kit-specs:specs.task-tdd --lang=general --task="docs/specs/002-tdd-command/tasks/TASK-001.md"
```
...
/developer-kit-specs:specs.task-tdd --lang=spring --task="docs/specs/001-user-service/tasks/TASK-004.md"
...
/developer-kit-specs:specs.task-tdd --lang=typescript --task="docs/specs/001-api-gateway/tasks/TASK-007.md"
...
/developer-kit-specs:specs.task-tdd --lang=nestjs --task="docs/specs/001-payment-service/tasks/TASK-006.md"
...
/developer-kit-specs:specs.task-tdd --lang=react --task="docs/specs/001-search-ui/tasks/TASK-011.md"
...
/developer-kit-specs:specs.task-tdd --lang=python --task="docs/specs/001-data-processor/tasks/TASK-008.md"
...
/developer-kit-specs:specs.task-tdd --lang=php --task="docs/specs/001-wp-plugin/tasks/TASK-009.md"
...
/developer-kit-specs:specs.task-implementation --lang=spring --task="docs/specs/001-feature/tasks/TASK-004.md"
```
...
- the recommended `/developer-kit-specs:specs.task-implementation` command to run next
...
/developer-kit-specs:specs.task-tdd --lang=general --task="docs/specs/001-feature/tasks/TASK-001.md"
...
# Then run task-tdd
/developer-kit-specs:specs.task-tdd --lang=spring --task="docs/specs/001-feature/tasks/TASK-001.md"
```

## Related Commands

- `/developer-kit-specs:specs.brainstorm` - Create functional specification from idea
- `/developer-kit-specs:specs.spec-to-tasks` - Convert specification into executable tasks
- `/developer-kit-specs:specs.task-implementation` - Implement a specific task (GREEN phase)
- `/developer-kit-specs:specs.task-review` - Verify implementation meets requirements
