...
description: WordPress theme development using Sage framework. Use this skill when creating WordPress themes with Sage, setting up Blade templates, configuring build tools (Vite, Bud), working with theme templates, implementing ACF integration, or customizing themes.
