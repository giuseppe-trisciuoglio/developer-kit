...
description: Comprehensive LangChain4j patterns for integrating with Model Context Protocol (MCP) servers, including tool providers, client configuration, resource handling, and AI service integration
