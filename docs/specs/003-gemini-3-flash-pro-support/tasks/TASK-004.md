...
status: implemented
started_date: ""
implemented_date: "2026-04-08"
reviewed_date: "2026-04-08"
completed_date: "2026-04-08"
cleanup_date: "2026-04-08"
dependencies:
  - "TASK-002"
optional: false
provides:
  - file: "plugins/developer-kit-tools/skills/gemini/SKILL.md"
    symbols:
      - "Example 1: Large codebase security review (gemini-3-flash)"
      - "Example 3: Structured output for automation (gemini-3-flash)"
      - "Example 4: Quick boilerplate generation (gemini-3-flash)"
      - "Example 5: Cost-effective CSV summary (gemini-3-flash)"
      - "Example 6: Fast iteration for microcopy prototyping (gemini-3-flash)"
