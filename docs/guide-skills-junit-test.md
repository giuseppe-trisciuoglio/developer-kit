...
**File**: `skills/junit-test/unit-test-controller-layer/SKILL.md`
...
**File**: `skills/junit-test/unit-test-service-layer/SKILL.md`
...
**File**: `skills/junit-test/unit-test-exception-handler/SKILL.md`
...
**File**: `skills/junit-test/unit-test-mapper-converter/SKILL.md`
...
**File**: `skills/junit-test/unit-test-security-authorization/SKILL.md`
...
**File**: `skills/junit-test/unit-test-caching/SKILL.md`
...
**File**: `skills/junit-test/unit-test-application-events/SKILL.md`
...
**File**: `skills/junit-test/unit-test-config-properties/SKILL.md`
...
**File**: `skills/junit-test/unit-test-scheduled-async/SKILL.md`
...
**File**: `skills/junit-test/unit-test-json-serialization/SKILL.md`
...
**File**: `skills/junit-test/unit-test-parameterized/SKILL.md`
...
**File**: `skills/junit-test/unit-test-utility-methods/SKILL.md`
...
**File**: `skills/junit-test/unit-test-boundary-conditions/SKILL.md`
...
**File**: `skills/junit-test/unit-test-wiremock-rest-api/SKILL.md`
...
**Note**: For complete patterns and examples, see individual skill files in `skills/junit-test/`
