...
**File**: `skills/langchain4j/langchain4j-spring-boot-integration/SKILL.md`
...
**File**: `skills/langchain4j/langchain4j-ai-services-patterns/SKILL.md`
...
**File**: `skills/langchain4j/langchain4j-rag-implementation-patterns/SKILL.md`
...
**File**: `skills/langchain4j/langchain4j-vector-stores-configuration/SKILL.md`
...
**File**: `skills/langchain4j/qdrant/SKILL.md`
...
**File**: `skills/langchain4j/langchain4j-tool-function-calling-patterns/SKILL.md`
...
**File**: `skills/langchain4j/langchain4j-mcp-server-patterns/SKILL.md`
...
**File**: `skills/langchain4j/langchain4j-testing-strategies/SKILL.md`
...
**Note**: For complete patterns and examples, see individual skill files in `skills/langchain4j/`
