...
**File**: `skills/spring-boot/spring-boot-dependency-injection/SKILL.md`
...
**File**: `skills/spring-boot/spring-boot-actuator/SKILL.md`
...
**File**: `skills/spring-boot/spring-boot-cache/SKILL.md`
...
**File**: `skills/spring-boot/spring-data-jpa/SKILL.md`
...
**File**: `skills/spring-boot/spring-data-neo4j/SKILL.md`
...
**File**: `skills/spring-boot/spring-boot-crud-patterns/SKILL.md`
...
**File**: `skills/spring-boot/spring-boot-event-driven-patterns/SKILL.md`
...
**File**: `skills/spring-boot/spring-boot-saga-pattern/SKILL.md`
...
**File**: `skills/spring-boot/spring-boot-rest-api-standards/SKILL.md`
...
**File**: `skills/spring-boot/spring-boot-resilience4j/SKILL.md`
...
**File**: `skills/spring-boot/spring-boot-security-jwt/SKILL.md`
...
**File**: `skills/spring-boot/spring-boot-test-patterns/SKILL.md`
...
**File**: `skills/spring-boot/spring-boot-openapi-documentation/SKILL.md`
...
**Note**: For complete patterns and examples, see individual skill files in `skills/spring-boot/`
