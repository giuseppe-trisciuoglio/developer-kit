...
**File**: `skills/aws-java/aws-sdk-java-v2-core/SKILL.md`
...
**File**: `skills/aws-java/aws-sdk-java-v2-s3/SKILL.md`
...
**File**: `skills/aws-java/aws-rds-spring-boot-integration/SKILL.md`
...
**File**: `skills/aws-java/aws-sdk-java-v2-dynamodb/SKILL.md`
...
**File**: `skills/aws-java/aws-sdk-java-v2-rds/SKILL.md`
...
**File**: `skills/aws-java/aws-sdk-java-v2-lambda/SKILL.md`
...
**File**: `skills/aws-java/aws-sdk-java-v2-secrets-manager/SKILL.md`
...
**File**: `skills/aws-java/aws-sdk-java-v2-kms/SKILL.md`
...
**File**: `skills/aws-java/aws-sdk-java-v2-messaging/SKILL.md`
...
**File**: `skills/aws-java/aws-sdk-java-v2-bedrock/SKILL.md`
...
**Note**: For complete patterns and examples, see individual skill files in `skills/aws-java/`
